  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="jhipsterSampleApplicationApp.location.home.createOrEditLabel"
          data-cy="LocationCreateUpdateHeading"
          v-text="t$('jhipsterSampleApplicationApp.location.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('jhipsterSampleApplicationApp.location.streetAddress')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jhipsterSampleApplicationApp.location.postalCode')"
              for="location-postalCode"
            ></label>
            <input
              type="text"
              class="form-control"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterSampleApplicationApp.location.city')" for="location-city"></label>
            <input
              type="text"
              class="form-control"
              name="city"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jhipsterSampleApplicationApp.location.stateProvince')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterSampleApplicationApp.location.country')" for="location-country"></label>
