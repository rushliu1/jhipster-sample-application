  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="jhipsterSampleApplicationApp.jobHistory.home.createOrEditLabel"
          data-cy="JobHistoryCreateUpdateHeading"
          v-text="t$('jhipsterSampleApplicationApp.jobHistory.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('jhipsterSampleApplicationApp.jobHistory.startDate')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jhipsterSampleApplicationApp.jobHistory.endDate')"
              for="job-history-endDate"
            ></label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jhipsterSampleApplicationApp.jobHistory.language')"
            ...
            >
              <option
                ...
                :key="language"
                :value="language"
                :label="t$('jhipsterSampleApplicationApp.Language.' + language)"
              >
                {{ language }}
              </option>
            </select>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterSampleApplicationApp.jobHistory.job')" for="job-history-job"></label>
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jhipsterSampleApplicationApp.jobHistory.department')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="t$('jhipsterSampleApplicationApp.jobHistory.employee')"
