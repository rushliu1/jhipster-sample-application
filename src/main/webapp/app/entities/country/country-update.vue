  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate @submit.prevent="save()">
        <h2
          id="jhipsterSampleApplicationApp.country.home.createOrEditLabel"
          data-cy="CountryCreateUpdateHeading"
          v-text="t$('jhipsterSampleApplicationApp.country.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="t$('jhipsterSampleApplicationApp.country.countryName')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('jhipsterSampleApplicationApp.country.region')" for="country-region"></label>
